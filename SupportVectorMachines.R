...
##############################
# In order to fit an SVM using a non-linear kernel, we use the svm()
# function. 
...
# 
# Both small Cost and small gamma mean low variance/high bias).
train <- sample(n, 100)
...
# fitted value for an observation. In essence, the sign of the fitted value
