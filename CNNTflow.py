...
'''
This is a TensorFlow implementation of methods described in the following papers:
...
I'm an artist, so seeing what neural networks can do with art is fascinating to me. This neural network will take an input image and an input style image
and combine the style of the aplty named style image with the input image to create something totally new; easily turn a photo into the likeness of a picasso.
'''
